...
const initiallyDisplayedCurrencies = [ "NGN", "USD", "GBP"];
let baseCurrency;
...
var currenciesListFocusOut = (event) => {
...
let newCurrenciesListItem = (currency) => {
